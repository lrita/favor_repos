...
* [ContentSquare/chproxy](https://github.com/ContentSquare/chproxy) ClickHouse http proxy and load balancer
...
* [dshulyak/uring](https://github.com/dshulyak/uring) Golang library for io_uring framework (without CGO)
